		   ...
		   @PostMapping("/appointments/{id}/approve")
		    ...
		    private void sendEmailToPatient(appoinment appointment) {
		        ...
		        String emailContent = "Dear " + appointment.getU_name() + ",\n\n"
		                + "We are delighted to confirm that your appointment has been approved. Below are the details:.\n\n"
		                + "Doctor Name: " + appointment.getC_name() + "\n" 
		                + "Available Date: " + appointment.getTime() + "\n"
		                + "Should you have any inquiries or require adjustments, feel free to reach out to us.\n\n"
		                + "Thank you for selecting ABC Laboratories.\n\n" + "Best Regards,\n" + "The ABC Laboratories Team";
		    ...
		    private void sendRejectionEmailToPatient(appoinment appointment) {
		        ...
		        String emailContent = "Dear " + appointment.getU_name() + ",\n\n"
		                + "We apologize to inform you that your appointment has been declined. Please find the details below:.\n\n"
		                + "Doctor Name: " + appointment.getC_name() + "\n" 
